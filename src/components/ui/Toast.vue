<template>
  <div v-if="visible" class="toast-wrapper fixed inset-0 z-50 flex justify-end items-start pointer-events-none">
    <!-- 背景蒙层，用于模态对话框 -->
    <div v-if="toast.isModal" class="bg-black/50 absolute inset-0 pointer-events-auto" @click="closeIfNotModal"></div>
      ...
      <div class="flex">
        ...
        <div class="flex-1">
          ...
          <div v-if="toast.isModal" class="mt-4 flex justify-end gap-2">
            ...
            <button @click="onConfirm" class="px-3 py-1.5 rounded-md text-sm bg-primary text-primary-foreground hover:bg-primary/90">
